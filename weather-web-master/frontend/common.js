...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="/latest_data.html" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Latest Data
            </a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="/latest_values.html">Latest Values</a>
            <a class="dropdown-item" href="/last500.html">Last 500</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="/datadump.html">Datadump</a>
            </div>
        </li>
        <li class="nav-item">
